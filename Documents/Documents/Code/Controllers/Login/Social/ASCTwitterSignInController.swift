//
//  ASCTwitterSignInController.swift
//  Documents
//
//  Created by Лолита Чернышева on 14.02.2022.
//  Copyright © 2022 Ascensio System SIA. All rights reserved.
//

import UIKit

class ASCTwitterSignInController: ASCConnectStorageOAuth2Delegate{
    ...
    func viewDidLoad(controller: ASCConnectStorageOAuth2ViewController) {
        ...
        let authRequest = "https://twitter.com/i/oauth2/authorize?/\(parameters.stringAsHttpParameters())"
    ...
    func shouldStartLoad(with request: String, in controller: ASCConnectStorageOAuth2ViewController) -> Bool {
        ...
        if let errorCode = controller.getQueryStringParameter(url: request, param: "error") {
            ...
            controller.complation?([
                "error": String(format: NSLocalizedString("Please retry. \n\n If the problem persists contact us and mention this error code: Twitter - %@", comment: ""), errorCode)
            ])
            return false
        }
